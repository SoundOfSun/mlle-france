...
t3 = Project.create!(name: 'korean conversation guide', category: 'pamphlet', description: 'An introductory pamphlet about the korean language for a cultural event', date: 'April 2015', job: 'teaching')
